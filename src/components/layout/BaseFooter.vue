    ...
    <div class="bg-light">
        <div class="navbar navbar-expand-lg container">
            <ul class="navbar-nav w-100">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="http://blog.bootcatch.com">
                        Blog
                    </a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" target="_blank" href="https://github.com/ajaymarathe/vue-blossom-design-system/blob/master/LICENSE">
                        MIT License
                    </a>
                </li>
            </ul>
