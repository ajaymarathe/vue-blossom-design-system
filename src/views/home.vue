<template>
    <div>
        ...
        <navbar></navbar>
        <!--end navbar section-->
        <div class="intro-section bg-danger">
                        ...
                        <div class="heading text-center">
                            ...
                            <div>
                                <a target="_blank" href="http://blog.bootcatch.com/post/vue-components-based-design-system-is-based-on-bootcatch-themes-and-vue" class="text-decoration-none">
                                 ...
                                 <a class="text-decoration-none" href="https://github.com/ajaymarathe/vue-blossom-design-system/archive/master.zip" >
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="mb-5">
                                ...
                                <div class="col-md-4">
                                    <base-card>
                                        ...
                                        <card-body>
                                            ...
                                            <base-button color="danger">Go somewhere</base-button>
                                        </card-body>
                                    </base-card>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <base-card class="bg-danger text-white">
                        ...
                        <h5 class="mb-4 text-uppercase">Forms</h5>
                        <div class="mb-5">
                            <div class="row">
                                <div class="col-md-4">
                ...
                <div class="mb-5">
                   ...
                   <div class="row">
                       <div class="col-md-3">
                           ...
                           <img class='img-fluid rounded' src="../assets/img/kajal800.png" alt="vue-supine-ui images">
                       </div>
                       <div class="col-md-3">
                           <h6 class="mb-4 text-uppercase">Circle</h6>
                           <img class='img-fluid rounded-circle' src="../assets/img/kajal800.png" alt="vue-supine-ui images">
                       </div>
                       <div class="col-md-3">
                           <h6 class="mb-4 text-uppercase">Thumbnail</h6>
                           <img class='img-fluid img-thumbnail' src="../assets/img/kajal800.png" alt="vue-supine-ui images">
                       </div>
                       <div class="col-md-3">
                           <h6 class="mb-4 text-uppercase">Shadow</h6>
                           <img class='img-fluid rounded shadow' src="../assets/img/kajal800.png" alt="vue-supine-ui images">
                       </div>
                   </div>
                </div>
                <div class="mb-5">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <base-button color="danger" size="block" data-toggle="modal" data-target="#exampleModal">
                                demo modal
                            </base-button>
                            <base-modal target="exampleModal">
                                ...
                                <modal-body>
                                    <h5 class="modal-title text-uppercase">{{ title }} modal</h5>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            beautiful documentation to help you out. It is based on <a class="text-danger" href="http://www.bootcatch.com/lightly" target="_blank">Blossom Theme</a>. Which is based on latest Bootstrap.</p>
                        ...
                        <div class="col-md-6">
                            <base-card class="border-success l-shapes light-shadow">
                                <img class="img-fluid" src="../assets/img/green.jpg" :alt="title">
                                <card-body>
